...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/old-butterfly-83b4)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/old-butterfly-83b4
```

A live public deployment of this template is available at [https://old-butterfly-83b4.templates.workers.dev](https://old-butterfly-83b4.templates.workers.dev)
